...
///
/// Inter = body + UI (sans).
/// PP Editorial New Light = display serif.
///
...
enum UnfoldFonts {
  ...
  static func printAvailableFonts() {
    let interesting = UIFont.familyNames
      .filter { $0.lowercased().contains("inter") || $0.lowercased().contains("editorial") }
