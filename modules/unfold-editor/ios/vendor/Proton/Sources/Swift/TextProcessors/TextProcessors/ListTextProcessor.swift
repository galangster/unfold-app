...
open class ListTextProcessor: TextProcessing {
    ...
    open func didProcess(editor: EditorView) {
        // Capture-and-clear BEFORE invoke: any replaceCharacters call inside
        // the callback can trigger a new process cycle; clearing first means
        // the inner didProcess won't re-invoke this same callback.
