...
const DAY_MESSAGES = [
  ...
  'Let this one stay with you.',
  'The word does its quiet work.',
  'Faithfulness looks like this.',
  'You chose to be present. That counts.',
  ...
  'Truth in. Noise out.',
  'One step at a time. That\'s faithfulness.',
  'God had something for you in that.',
  'Let this linger a while.',
  'Rest in what you just received.',
  'You are being shaped by this.',
  'What you do in private shapes who you become.',
  ...
  'That time you just gave? It compounds.',
  'That was time well spent.',
  'You chose substance over noise.',
  'Growth happens on the ordinary days.',
  'God sees the days nobody else does.',
  'You carved out space for what lasts.',
  'Another brick in the foundation.',
  'This is what it looks like to build.',
  'Today\'s obedience is tomorrow\'s freedom.',
  'Five minutes with God. Never wasted.',
  'You were present. That\'s the hard part.',
  'Let this truth take root.',
  'You made today count.',
  'The rhythm itself is forming you.',
  'That was between you and God.',
  'That was between you and God.',
  'A little more capacity for grace today.',
  ...
  'What you just read will keep working on you.',
...
const SERIES_MESSAGES = [
  ...
  'This series is part of you now.',
  ...
  'You gave this series everything.',
