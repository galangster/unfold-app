...
describe('feature announcement sequence', () => {
  ...
  it('records a page as seen when it displays and advances with Next', () => {
    ...
    expect(screen.getByText('Tap or swipe your book in the Devotional tab to open your reading. Find finished books and your first devotional in Profile, then Past Devotionals. Share book covers there, too.')).toBeTruthy();
