 ...
 *
 * This is NOT a general-purpose HTML parser. It assumes well-formed HTML
 * produced by tentap-editor (or legacyMarkdownToHtml) — balanced tags, no
 * comments, no doctype, attributes quoted. We verify outputs via tests
 * and fall back gracefully on unexpected input rather than throwing.
 */
