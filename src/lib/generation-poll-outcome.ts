 ...
 * unchanged, and Today reconciles the record against the server (its watch
 * for a record marked leftForHome, `resolveInflightResume` otherwise). With
 * no job there is nothing to resume, so the record is cleared.
 */
